...
export function create() {
  ...
  const groundLayer = map.createStaticLayer(
    "Ground",
    [tileset1, tileset2],
    0,
    0
  ...
  const BuildingsLayer = map.createStaticLayer(
    "Building",
    [tileset1, tileset2, tileset7, tileset5, tileset8, tileset9, tileset10],
    0,
    0
  );
  const letterLayer = map.createStaticLayer(
    "Letters",
    [tileset1, tileset2, tileset7, tileset5, tileset8, tileset9],
    0,
    0
  );
  const constructionLayer = map.createStaticLayer(
    "Construction",
    [tileset4, tileset8],
    0,
    0
  ...
  ); // add function to make the player run
